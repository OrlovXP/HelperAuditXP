            ...
            <form action="{{ route('products.store') }}" method="post">
                ...
                <div class="flex gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="crm_product_id" name="crm_product_id" value="{{ old('crm_product_id') }}" class="border-gray-300/50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#13A2AF]/30 focus:border-[#13A2AF]/30 block w-full p-2.5 outline-none"/>
